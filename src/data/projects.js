export const projects = [
  ...
  },
  {
    ...
    meta: 'PUZZLE BOX · 2024/25',
    tech: 'ARDUINO · C++',
    tags: ['PUZZLE BOX', 'ARDUINO', 'C++', '2024/25'],
    section: 'THE GAME',
...
export const skills = [
  ...
  },
  {
    group: 'XR & TOOLS',
    items: [
      { name: 'META QUEST 3 / MR', pct: 88 },
      { name: 'XR INTERACTION TOOLKIT', pct: 82 },
      { name: 'BLUEPRINTS', pct: 75 },
      { name: 'MATERIAL NODES / HLSL', pct: 68 },
    ],
  },
  {
    group: 'NETWORKING',
    items: [
      { name: 'NETCODE FOR GAMEOBJECTS', pct: 74 },
    ],
  },
]
